...
class WC_Xendit_CC_Addons extends WC_Xendit_CC
{
    ...
    public function update_failing_payment_method($subscription, $renewal_order)
    {
        ...
        if ($this->wc_pre_30) {
            update_post_meta($subscription->get_id(), '_xendit_card_id', $renewal_order->xendit_card_id);
        } else {
        ...
        $payment_meta[ $this->id ] = array(
            'post_meta' => array(
                '_xendit_card_id' => array(
                    'value' => get_post_meta(( $subscription->get_id() ), '_xendit_card_id', true),
    ...
    public function maybe_render_subscription_payment_method($payment_method_to_display, $subscription)
    {
        ...
        $xendit_card_id     = get_post_meta(( $subscription->get_id() ), '_xendit_card_id', true);
