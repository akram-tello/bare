...
<div class="uap-row">
		...
		<div class="uapcol-md-2 uap-account-payments-tab2">
			<div class="uap-account-no-box uap-account-box-lightblue"><div class="uap-account-no-box-inside"><div class="uap-count"><?php echo esc_uap_content($data['stats']['payments']);?></div><div class="uap-detail"><?php esc_html_e('Total number of Transactions', 'uap');?></div></div></div>
		</div>
	</div>
