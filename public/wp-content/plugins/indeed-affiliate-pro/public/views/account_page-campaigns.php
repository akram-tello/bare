	...
	<form method="post"  id="uap_campaign_form">
		...
		<?php foreach ($data['campaigns'] as $campaignId => $value ) : ?>
			<div class="uap-account-campaign-list">
				<div class="uap-aling-float-left"><strong><?php echo esc_html($value);?></strong></div>
				<div class="uap-aling-float-right"><i class="fa-uap fa-trash-uap uap-js-account-page-campaigns-delete-item" data-id="<?php echo esc_attr($campaignId);?>"></i></div>
				<div class="uap-clear"></div>
			</div>
		<?php endforeach;?>
		</div>
