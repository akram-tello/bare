...
<?php if ((!empty($data['items']) && is_array($data['items'])) || !empty($data['filtered'])): ?>
	...
	<div class="uap-row">
		...
		<div class="uapcol-md-3 uap-account-referrals-tab3">
			<div class="uap-account-no-box uap-account-box-lightblue"><div class="uap-account-no-box-inside"><div class="uap-count"><?php echo esc_uap_content($data['stats']['referrals']);?></div><div class="uap-detail"><?php esc_html_e('Total No of Referrals', 'uap');?></div></div></div>
		</div>
	</div>
	<?php endif; ?>
