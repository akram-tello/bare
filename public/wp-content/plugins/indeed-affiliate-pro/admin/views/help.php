	...
	<form method="post" >
		<div class="inside">
			...
			<div class="uap-form-line uap-no-border uap-help-seetings-sectiontwo">
				<input name="uap_envato_code" type="password" value="<?php echo esc_attr($data['uap_envato_code']);?>"/>
			</div>
			<div class="uap-stuffbox-submit-wrap uap-license-button uap-help-seetings-sectionthree">
                ...
                <?php else: ?>
                	<input type="submit" value="<?php esc_html_e('Activate License', 'uap');?>" name="uap_save_licensing_code" <?php echo esc_attr($disabled);?> class="button button-primary button-large" />
                <?php endif;?>
			</div>
