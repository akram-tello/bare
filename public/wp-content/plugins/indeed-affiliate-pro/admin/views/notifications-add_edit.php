		...
		<div class="uap-stuffbox">
				...
				<div class="inside">
							...
							<?php
								switch ($k){
									case 'admin_user_register':
										echo esc_uap_content(' <optgroup label="' . esc_html__('Register Process', 'uap') . '">');
										break;
									case 'affiliate_payment_fail':
										echo esc_uap_content(' <optgroup label="' . esc_html__('Payments', 'uap') . '">');
										break;
									case 'reset_password_process':
										echo esc_uap_content(' <optgroup label="' . esc_html__('Password', 'uap') . '">');
										break;
									case 'affiliate_account_approve':
										echo esc_uap_content(' <optgroup label="' . esc_html__('Profile Update', 'uap') . '">');
										break;
									case 'admin_on_aff_change_rank':
										echo esc_uap_content(' <optgroup label="' . esc_html__('Admin', 'uap') . '">');
										break;
									case 'email_check':
										echo esc_uap_content(' <optgroup label="' . esc_html__('Double E-mail Verification', 'uap') . '">');
										break;
					...
					<div class="uap-form-line">
						...
						<input type="text" value="<?php echo esc_attr($data['subject']);?>" name="subject" id="notf_subject" />
					</div>
					<div class="uap-form-line">
						...
						<?php
							...
							echo esc_uap_content("<h4>" . esc_html__('Custom Fields constants', 'uap') . "</h4>");
