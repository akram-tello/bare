          ...
          <div class="row">
            ...
            <div class="uap-form-line">
					...
					<ul class="uap-info-list">
						...
						<li><?php esc_html_e( '3. Go to "Webhooks" and set Your Webhook at: ', 'uap');?> <?php echo esc_uap_content("<b>" . $notification_url . "</b>");?></li>
						...
						<li><?php esc_html_e( '11. In "Redirects" add URI', 'uap' );?> <?php echo esc_uap_content("<b>" . $oauthRedirectBackPage . "</b>");?></li>
