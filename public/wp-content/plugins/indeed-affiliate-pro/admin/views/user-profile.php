                           	...
                           	<div class="row uap-userprofile-rank-row">
                            	<div class="col-xs-5">
                                	<div class="uap-userprofile-rank uap-currentrank">
                                    	<div class="uap-userprofile-rank-title"><?php echo esc_html($data['current_rank_data']['label']);?>
                                	...
                                	<tr class="form-field">
                                    	<th>
                                          ...
                                          <?php $totalAmount = $data['referrals_stats']['verified_referrals_amount'] + $data['referrals_stats']['unverified_referrals_amount'];?>
                                        	<div> <a href="<?php echo admin_url( 'admin.php?page=ultimate_affiliates_pro&tab=referrals&affiliate_id=' . $data['affiliate_id'] );?>" target="_blank"><?php echo esc_html($data['stats']['referrals']);?> (<?php echo uap_format_price_and_currency( $data['currency'], $totalAmount );?>)</a></div>
                                        </th>
                                        <td>
                                        	<div><?php esc_html_e( 'Verified:', 'uap' );?>: <?php echo esc_html($data['referrals_stats']['verified_referrals']);?> (<?php echo uap_format_price_and_currency( $data['currency'], $data['referrals_stats']['verified_referrals_amount'] );?>)</div>
                                        	<div><?php esc_html_e( 'UnVerified:', 'uap' );?>: <?php echo esc_html($data['referrals_stats']['unverified_referrals']);?> (<?php echo uap_format_price_and_currency( $data['currency'], $data['referrals_stats']['unverified_referrals_amount'] );?>)</div>
                                        </td>
                                    </tr>
                                    <tr class="form-field">
