...
if ($data['visit_graph']){
	...
	></span>
	<span class="uap-js-reports-tick-type" data-value="<?php echo esc_attr($data['tick_type']);?>"></span>
	<span class="uap-js-min-time" data-value="<?php echo esc_attr($start_time . '000'); ?>"></span>
	<span class="uap-js-max-time" data-value="<?php echo esc_attr($end_time . '000');?>"></span>
