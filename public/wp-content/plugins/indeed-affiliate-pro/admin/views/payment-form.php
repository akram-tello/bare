		...
		<div class="row">
				...
				<div class="col-xs-4">
					<div class="payment-box">
						...
						<?php endif;?>
						<div  class="uap-list-affiliates-name-label">
							<input type="radio" value="bank_transfer" name="paywith" onClick="uapPaymentFormPaymentStatus(this.value);" <?php echo esc_attr($checked_bt);?> /> <?php esc_html_e('Bank Transfer', 'uap');?>
						</div>
						...
						<div class="uap-list-affiliates-name-label" >
							<input type="radio" value="stripe_v2" name="paywith" onClick="uapPaymentFormPaymentStatus(this.value);" <?php echo esc_attr($checked_stripe_v2);?> /> <?php esc_html_e('Stripe V2', 'uap');?>
						</div>
						<?php endif;?>
						<?php if (!empty($data['stripe_v3'])):?>
						<div class="uap-list-affiliates-name-label">
							<input type="radio" value="stripe_v3" name="paywith" onClick="uapPaymentFormPaymentStatus(this.value);" <?php echo esc_attr($checked_stripe_v3);?> /> <?php esc_html_e('Stripe V3', 'uap');?>
						</div>
						<?php endif;?>
					</div>
				</div>
						...
						if (!empty($data['affiliate_pay']['payment_gateway_data']) && !empty($data['affiliate_pay']['payment_gateway_data']['type'])){
							...
							switch ($temp_key):
								...
								case 'stripe_v2':
									...
									?>
									<span class="uap-admin-aff-payment-type <?php echo esc_attr($payment_class);?>">Stripe V2</span>
									<?php
									break;
								case 'stripe_v3':
										$payment_class = '';
										...
										?>
										<span class="uap-admin-aff-payment-type <?php echo esc_attr($payment_class);?>">Stripe V3</span>
										<?php
										break;
							endswitch;
						} else {
