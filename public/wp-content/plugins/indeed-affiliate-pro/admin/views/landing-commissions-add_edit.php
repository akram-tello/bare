				...
				<div class="col-xs-6">
					...
					<p><?php esc_html_e( 'Based on the landing commission price, the referral amount will be calculated depending on each affiliate rank amount.', 'uap');?></p>
					 <div class="input-group">
						...
						<input type="number" step='<?php echo uapInputNumerStep();?>' min="0"   class="form-control uap-lc-input-number" name="amount_value" value="<?php echo esc_attr($data['metas']['amount_value']);?>" aria-describedby="basic-addon1" /> <span class="uap-lc-cookie-time"><?php echo esc_html($currency);?></span>
					 </div>
				 		<br/>
			...
			<div class="row">
				<div class="col-xs-6">
					...
					<div class="input-group">
						...
						<input type="number" min="0" step="1" class="form-control uap-lc-input-number" name="cookie_expire" value="<?php echo esc_attr($data['metas']['cookie_expire']);?>" aria-describedby="basic-addon1" />  <span class="uap-lc-cookie-time"><?php esc_html_e( 'Hours', 'uap');?></span>
					 </div>
				</div>
			</div>
		</div>
