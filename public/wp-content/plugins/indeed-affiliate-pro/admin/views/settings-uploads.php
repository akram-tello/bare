	...
	<div class="uap-stuffbox">
		...
		<div class="inside">
			...
			<div class="uap-form-line">
				...
				<div class="inside">
					<input type="number" value="<?php echo esc_attr($data['metas']['uap_upload_max_size']);?>" name="uap_upload_max_size" min="0.1" step="0.1" /> MB
				</div>
			</div>
			...
			<div class="uap-form-line">
				...
				<div class="inside">
					<input type="number" value="<?php echo esc_attr($data['metas']['uap_avatar_max_size']);?>" name="uap_avatar_max_size" min="0.1" step="0.1" /> MB
				</div>
			</div>
