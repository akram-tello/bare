				...
				<div class="row">
					...
					<div class="col-xs-12">
						...
						<?php foreach ($types as $name=>$label):?>
								<div class="uap-form-line">
										<label class="uap-labels-special"><?php echo esc_html($label);?></label>
										<input type="text" value="<?php echo esc_attr($data['metas']['uap_custom_source_name_' . $name]);?>" name="<?php echo esc_attr('uap_custom_source_name_' . $name);?>" />
								</div>
						<?php endforeach;?>
					</div>
