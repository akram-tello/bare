...
class ElCheck
{
    ...
    public function ajax()
    {
        ...
        update_option( $this->purchaseOptionName, sanitize_text_field($_POST['purchase_code']) );
        // redirect link to envato
        echo esc_uap_content($this->getRedirectLinkToWpIndeed( sanitize_text_field( $_POST['purchase_code'] ) ));
        die;
    }
